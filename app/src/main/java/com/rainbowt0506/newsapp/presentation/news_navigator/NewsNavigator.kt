package com.rainbowt0506.newsapp.presentation.news_navigator
...
import com.rainbowt0506.newsapp.presentation.details.DetailsEvent
import com.rainbowt0506.newsapp.presentation.details.DetailsScreen
import com.rainbowt0506.newsapp.presentation.details.DetailsViewModel
...
import com.rainbowt0506.newsapp.presentation.news_navigator.components.BottomNavigationItem
import com.rainbowt0506.newsapp.presentation.news_navigator.components.NewsBottomNavigation
            ...
            composable(route = Route.DetailsScreen.route) {
                ...
                navController.previousBackStackEntry?.savedStateHandle?.get<Article>("article")
                    ?.let { article ->
                        DetailsScreen(
                            article = article,
                            event = viewModel::onEvent, navigateUp = {
